<nav class="home navbar dropdown">
...
<?php if($user->issupereditor()) { ?>
    <details id="json">
        ...
        <div class="submenu">
            <form action="<?= $this->url('pageupload') ?>" method="post" enctype="multipart/form-data" class="submenu-section">
    ...
    <details id="edit">
        ...
        <form action="<?= $this->url('multi') ?>" method="post" id="multi" class="submenu">
            ...
            <div class="submenu-section">
                ...
                <p class="field">
                    ...
                    <option value="" disabled selected>--keep author--</option>
                        <?php
    ...
    <details id="selection" <?= !empty($optlist) ? 'open' : '' ?>>
        ...
        <div class="submenu">
            <form action="<?= $this->url('homequery') ?>" method="post" class="submenu-section">
                <h2>
                    List menu
                    <span class="right">
    ...
    <details id="bookmark">
        ...
        <div class="submenu">
            <?php if(empty($matchedbookmarks)) { ?>
                <form action="<?= $this->url('bookmarkadd') ?>" method="post" class="submenu-section">
                    <h2>New bookmark</h2>
                    <p class="field">Save those filters as a bookmark</p>
                ...
                <?php if(!empty($editablebookmarks)) { ?>
                    <form action="<?= $this->url('bookmarkupdate') ?>" method="post" class="submenu-section">
            ...
            <?php } else { ?>
                <?php foreach ($matchedbookmarks as $bookmark) { ?>
                    ...
                    <form action="<?= $this->url('bookmarkupdate') ?>" method="post" class="submenu-section">
                        ...
                        <?php } ?>
                        <p class="field submit"><input type="submit" value="update"></p>
                    </form>
                    ...
                    <form action="<?= $this->url('bookmarkdelete') ?>" method="post" class="submenu-section">
                        <h2>Delete</h2>
                        <input type="hidden" name="id" value="<?= $bookmark->id() ?>">
                        <input type="hidden" name="route" value="home">
                        <input type="hidden" name="confirmdelete" value="0">
    ...
    <details id="display">
        ...
        <div class="submenu">
            <form action="<?= $this->url('homecolumns') ?>" method="post" class="submenu-section">    
                <h2>Columns</h2>
                ...
                <?php } ?>
                <p class="field formsubmit">
                    <input type="submit" value="update columns">
                </p>
            </form>

            <?php if($user->issupereditor()) { ?>
            <form action="<?= $this->url('homecolors') ?>" method="post" class="submenu-section">
                <h2>Tag colors</h2>
