<div id="leftbar" class="collapsible panel">
    <input
    ...
    >
    <label for="showeditorleftpanel" class="toggle-label"><span>◧</span></label>
    
    <div class="collapsible-content panel-section " id="leftbarpanel">
        <div class="scroll editbar-scroll">
